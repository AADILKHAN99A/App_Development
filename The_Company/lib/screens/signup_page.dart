...
import 'package:the_company/controllers/signup_controller.dart';
import 'package:the_company/ui_helpers/helper_widgets.dart';
import 'package:the_company/helper_functions/signup_helper.dart';
import 'package:the_company/ui_helpers/textfield_ui.dart';
...
class _SignupPageState extends State<SignupPage> {
  ...
  late SignUp signUp = SignUp(context);
  ...
  Future<bool?> validateAllFields() async {
    if (_formKeyPhone.currentState!.validate() &&
      ...
      bool isVerified =
          await signUp.validateOtp(_codeController.text.toString());
      return isVerified;
    }
    return null;
  }
  ...
  void validatePhone() async {
    if (_formKeyPhone.currentState!.validate()) {
      ...
      await signUp
        ...
        if (available != true) {
          await signUp.getOtp(controllerPhone);
        }
                            ...
                            child: Obx(() => ElevatedButton(
                                  ...
                                  onPressed: () async {
                                    await validateAllFields()
                                      ...
                                      if (isVerified == true) {
                                        await SignUp(context).registerUser(
