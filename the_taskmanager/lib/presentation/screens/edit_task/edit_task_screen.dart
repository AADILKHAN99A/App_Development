...
import 'package:the_taskmanager/presentation/screens/edit_task/controller/edit_task_controller.dart';
...
class _EditTaskScreenState extends State<EditTaskScreen> {
  late EditTaskController controller;

  @override
  void initState() {
    super.initState();
    controller = Get.put(EditTaskController());
    controller.updateAllData(index: widget.arguments[0]["index"]);
  }
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                ColorPicker(
                  controller: EditTaskController.instance,
                ),
                MyButton(
                  label: "Done Edit",
                  onTap: () {
                    controller.validateTask(
                        index: widget.arguments[0]["index"]);
                  },
                )
              ],
            )
